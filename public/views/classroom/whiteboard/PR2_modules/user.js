...
PR2.user = (function(self){
	...
	var _setCredentials = function(credentials) {
		...
		else if (!$.inArray(credentials.level, ['tutor', 'student'])) {
			throw new Error('Level must be tutor or student');
		}
	...
	self = {
		 ...
		 * @return {object} credentials with keys 'name' and 'level' (level can be 'tutor' or 'student')
		 */
		 ...
		 * @param role {Object} (object containing the level ('tutor' or 'student') and name of the participant
