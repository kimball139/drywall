...
PR2.textEditor = (function(self) {
    ...
    $.subscribe(editor, {
        ...
        mouseout: function() {
            ...
            wrapper.style.borderColor = ru_handle.style.backgroundColor = rd_handle.style.backgroundColor = ld_handle.style.backgroundColor  = lu_handle.style.backgroundColor  = '#2f84b5';
            editor_focus = false;
        },
